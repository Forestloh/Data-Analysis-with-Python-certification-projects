...
def calculate_demographic_data(print_data=True):
    ...
    rich_percentage = (rich_count / num_min_workers) * 100

    # What country has the highest percentage of people that earn >50K? (see jupyter notebook for working)
    highest_earning_country = 'Iran'
    highest_earning_country_percentage = 41.9

    # Identify the most popular occupation for those who earn >50K in India. (see jupyter notebook for working)
